...
import SubjectiveAnswersTab, { HighlightedText } from "@/components/SubjectiveAnswersTab";
...
function EssaysTab() {
  ...
  const [activeEssayTab, setActiveEssayTab] = useState<"nota" | "desvios" | "comentarios" | "estat" | "texto">("nota");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 space-y-4">
            <div className="soe-card p-6 space-y-6">
              ...
              <button onClick={handleCreate} disabled={saveEssay.isPending || isTranscribing}
                ...
                {saveEssay.isPending ? <RotateCcw className="animate-spin" /> : isTranscribing ? <><RotateCcw className="animate-spin" size={18} /> Aguarde a Transcrição...</> : <><Send size={18} /> Salvar e Corrigir</>}
              </button>
            </div>
          </div>
        </div>
