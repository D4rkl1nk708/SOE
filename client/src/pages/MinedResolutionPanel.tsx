      ...
      <div className="fixed inset-0 z-[100] bg-background flex items-center justify-center p-6">
        <div className="max-w-md w-full soe-card text-center space-y-6 py-12">
          ...
          <p className="text-muted-foreground text-sm">
            Ative as provas na sua biblioteca para carregar as questões no
            filtro.
          </p>
          ...
          <div className="space-y-3">
            {currentQ.alternatives.map((alt: any) => {
              ...
              return (
                ...
                >
                  <div
                    className={`shrink-0 w-7 h-7 rounded-md flex items-center justify-center font-bold text-xs transition-colors ${
                      showAsCorrect
                  ...
                  {showResult && isCorrect && (
                    <CheckCircle2
                      className="ml-auto text-accent-green shrink-0"
                      size={18}
                    />
                  )}
          ...
          {!showResult ? (
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 h-12 rounded-xl bg-secondary hover:bg-muted text-xs font-bold transition-colors"
              >
                Revisar
              </button>
              <button
                onClick={nextQuestion}
                className="flex-[2] h-12 btn-apple-primary text-xs font-bold flex items-center justify-center gap-2"
              >
